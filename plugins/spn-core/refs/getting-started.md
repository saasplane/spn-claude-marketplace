...
The walk from nothing to a first feature in flight. Every step names the command or verb that carries it; statuses are honest — ✅ runs today, 🚧 the verb is still being built.
...
- **The agent arrives equipped** — after step 3 it holds the persona, the skills, and rules matched to what is actually installed, and reads contract surfaces on demand instead of remembering them.
